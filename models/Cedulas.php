 ...
 * @property StatusCedulas $status
 * @property CedulasTelefonicas[] $cedulasTelefonicas
 * @property Tiposasesorias[] $tiposasesorias
 */
class Cedulas extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['status_id'], 'exist', 'skipOnError' => true, 'targetClass' => StatusCedulas::className(), 'targetAttribute' => ['status_id' => 'id']],
        ];
    }
    ...
    {
        return $this->hasOne(StatusCedulas::className(), ['id' => 'status_id']);
    }
    ...
    {
        return $this->hasMany(CedulasTelefonicas::className(), ['cedula_id' => 'id']);
    }

    /**
     * @return \yii\db\ActiveQuery
     */
    public function getTiposasesorias()
    {
        return $this->hasMany(Tiposasesorias::className(), ['cedula_id' => 'id']);
    }
}
